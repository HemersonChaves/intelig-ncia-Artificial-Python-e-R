...
variaveis <- set(
  ...
  SABA = fuzzy_partition(varname = c(MenDSemanas = 20, MaiDSemanas = 30, Diario = 70, DuasxDia = 90), sd = 10),
  DebitoExp = fuzzy_partition(varname = c(CinqOiten = 20, TrintTCinqCin = 30, MaisTrintT = 70), sd = 10),
  Classificacao = fuzzy_partition(varname = c(Moderada = 20, AgudaGrave=40, RiscoVida = 60), sd = 10)
)
...
# defuzication
# method = c("meanofmax", "smallestofmax", "largetofmax", "centroid))
